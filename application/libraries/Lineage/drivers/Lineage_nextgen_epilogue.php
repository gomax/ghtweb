...
class Lineage_nextgen_epilogue extends CI_Driver
{
    public $version = 'e';
    ...
    {
        $this->db->select('castle.id,castle.`name`,castle.taxPercent AS taxPercent,castle.siegeDate,ally_data.crest AS ally_crest_id,clan_data.crest AS crest_id,clan_data.largecrest AS crest_large_id,clan_data.clan_level,clan_data.hasCastle,
    ...
    {
        $this->db->select('siege_clans.unit_id AS castle_id,siege_clans.clan_id,siege_clans.type,IF(siege_clans.type = "attackers",1,2) AS type,clan_subpledges.`name` AS clan_name,clan_data.clan_level,clan_subpledges.leader_id,
