...
<?php echo form_open('', 'class="form-horizontal"') ?>
    <fieldset>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="page" id="page" value="<?php echo set_value('page', $content['page']) ?>" class="input-block-level" placeholder="Введите Ссылку латинскими буквами" />
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="seo_title" id="seo_title" value="<?php echo set_value('seo_title', $content['seo_title']) ?>" class="input-block-level" placeholder="Введите СЕО титул" />
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="seo_keywords" id="seo_keywords" value="<?php echo set_value('seo_keywords', $content['seo_keywords']) ?>" class="input-block-level" placeholder="Введите СЕО ключевые слова" />
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="seo_description" id="seo_description" value="<?php echo set_value('seo_description', $content['seo_description']) ?>" class="input-block-level" placeholder="Введите СЕО описание" />
