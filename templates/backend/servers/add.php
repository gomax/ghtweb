    ...
    <div class="tab-content">
        <div class="tab-pane active" id="other">
            ...
            <div class="control-group<?php echo (form_error('version') ? ' error' : '') ?>">
                ...
                <div class="controls">
                    <?php echo form_dropdown('version', $this->config->item('types_of_servers', 'lineage'), set_value('version')) ?>
        ...
        <div class="tab-pane fade" id="donat">
            ...
            <div class="control-group<?php echo (form_error('donat_allow') ? ' error' : '') ?>">
                ...
                <div class="controls">
                    <input type="hidden" name="donat_allow" value="<?php echo set_value('donat_allow', 0) ?>" />
                    <div data-toggle="buttons-radio" class="btn-group">
                        <button class="btn btn-success <?php echo set_value('donat_allow', 0) == 1 ? 'active' : '' ?>" type="button" data-value="1">Вкл</button>
                        <button class="btn btn-danger <?php echo set_value('donat_allow', 0) == 0 ? 'active' : '' ?>" type="button" data-value="0">Выкл</button>
                    </div>
            ...
            <div class="control-group<?php echo (form_error('donat_item_id') ? ' error' : '') ?>">
                ...
                <div class="controls">
                    <input type="text" name="donat_item_id" id="donat_item_id" value="<?php echo set_value('donat_item_id', 4037) ?>" class="span10" placeholder="Введите ID предмета который будет выдан" />
            ...
            <div class="control-group<?php echo (form_error('donat_item_type') ? ' error' : '') ?>">
                ...
                <div class="controls">
                    <?php echo form_radio('donat_item_type', 1, TRUE) ?> Прибавиться к существующему <br />
                    <?php echo form_radio('donat_item_type', 0) ?> Добавиться в отдельную ячейку <br />
            ...
            <div class="control-group<?php echo (form_error('donat_item_name') ? ' error' : '') ?>">
                ...
                <div class="controls">
                    <input type="text" name="donat_item_name" id="donat_item_name" value="<?php echo set_value('donat_item_name', 'Coin of Luck') ?>" class="span10" placeholder="Введите название предмета который будет выдан" />
            ...
            <div class="control-group<?php echo (form_error('donat_table') ? ' error' : '') ?>">
                ...
                <div class="controls">
                    <?php echo form_dropdown('donat_table', array_combine($this->config->item('donat_table', 'lineage'), $this->config->item('donat_table', 'lineage'))) ?>
            ...
            <div class="control-group<?php echo (form_error('donat_item_cost') ? ' error' : '') ?>">
                ...
                <div class="controls">
                    <input type="text" name="donat_item_cost" id="donat_item_cost" value="<?php echo set_value('donat_item_cost', 30) ?>" class="span10" placeholder="Введите стоймость предмета" />
